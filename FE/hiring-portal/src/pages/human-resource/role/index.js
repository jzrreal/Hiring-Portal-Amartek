    ...
    <>
              ...
              <div className="col-12">
                <div className="card">
                  <div className="card-body">
                    <a className="btn btn-primary mb-3" data-toggle="modal" data-target="#addModal"><i className="fas fa-plus mr-2"></i> New Role</a>
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="addModalLabel">Create New Role</h5>
      ...
      <div className="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="editModalLabel">Detail Role</h5>
              <button type="button" className="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
