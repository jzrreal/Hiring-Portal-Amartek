  ...
  const columns = [
    ...
    },
    {
      ...
      selector: row => {
        return (
          <>
            <NavLink to={`/human-resource/skill-level/edit/${row.id}`} className="btn btn-sm btn-warning mr-2"><i className="fas fa-pencil-alt"></i></NavLink>
          ...
          <div className="container-fluid">
            <div className="row mb-2">
              <div className="col-sm-6">
                <NavLink to="/human-resource/skill-level/add" className="btn btn-primary"><i className="fas fa-plus mr-2"></i> New Skill Level</NavLink>
              </div>
              <div className="col-sm-6">
