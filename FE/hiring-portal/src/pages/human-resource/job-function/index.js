  ...
  const columns = [
    ...
    },
    {
      ...
      selector: row => {
        return (
          <>
            <NavLink to={`/human-resource/job-function/edit/${row.id}`} className="btn btn-sm btn-warning mr-2"><i className="fas fa-pencil-alt"></i></NavLink>
          ...
          <div className="container-fluid">
            <div className="row mb-2">
              <div className="col-sm-6">
                <NavLink to="/human-resource/job-function/add" className="btn btn-primary"><i className="fas fa-plus mr-2"></i> New Job Function</NavLink>
              </div>
              <div className="col-sm-6">
